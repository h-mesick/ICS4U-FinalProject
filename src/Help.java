...
public class Help extends BaseScene {
    ...
    private void page2() {
        ...
        enter.setFont(Util.getMainFont(20));
        list.add(enter, 0, 1);
        Text content = new Text("Use the enter key, or the left click on mouse to move through the scenes.");
        content.setFont(Util.getMainFont(15));
        list.add(content, 1, 1);
